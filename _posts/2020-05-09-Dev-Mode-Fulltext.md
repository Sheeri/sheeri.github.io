...
1. Fill in the appropriate information - cluster name with RealmSync modifier, the database is "wildaid", the partition key is "agency". Click "Turn Dev Mode On":
...
1.  Add fulltext search index - go to the Atlas UI for the cluster and click on the "Collections" tab. Click on the "BoardingReports" collection, then click on the "Search" tab, and then "Create Search Index":
